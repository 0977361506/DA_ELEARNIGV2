								...
								<div class="event_body d-flex flex-row align-items-start justify-content-start">
									...
									<div class="event_content">
										...
										<div class="event_info_container">
											<div class="event_info"><i class="fas fa-user-edit" aria-hidden="true"></i><span>Tác Giả  :  ${cc.user.username}</span></div>
											<div class="event_info"><i class="fa fa-clock-o" aria-hidden="true"></i><span>${cc.timeCreate}</span></div>
