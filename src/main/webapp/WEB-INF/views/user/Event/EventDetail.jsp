				...
				<div class="col-lg-4">
					<div class="sidebar">
						...
						<div class="sidebar_section">
							<div class="sidebar_section_title">Danh mục sự kiện</div>
							<div class="sidebar_categories">
								<ul class="categories_list">
								   <c:forEach var="l" items="${list}">
									<li><a href="/event/category/detail/${l.id}" data-id="${l.id}" class="clearfix clearfixs" >${l.nameDetail}</a></li>
									</c:forEach>
							...
							<div class="sidebar_latest">
							 ...
							 <c:forEach var="cc" items="${listnews}">
								<div class="latest d-flex flex-row align-items-start justify-content-start">
									<div class="latest_image"><div><img src="/images/${cc.image}" alt=""></div></div>
									<div class="latest_content">
										<div class="latest_title  latest_titles"><a data-id= "${cc.id}" href="#">${cc.title}</a></div>
