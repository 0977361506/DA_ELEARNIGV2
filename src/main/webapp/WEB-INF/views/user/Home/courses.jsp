				...
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="courses_search_container">
							<form action="/home/search/courses" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
								<input type="search" value="${param.key}" name="key" class="courses_search_input" placeholder="Search Courses" required="required" style="width: 480px;">
						...
						<div class="sidebar">
							...
							<div class="sidebar_section">
                                ...
                                <li class="list-group-item active bg-green-dark">
                                 <a href="/home/mycourses" style="color: white;">Khóa học của tôi <i class="fa fa-circle pull-right" style="position: relative; top: 4px"></i></a>
                               </li>
                               </ul>
								</div>
							</div>
