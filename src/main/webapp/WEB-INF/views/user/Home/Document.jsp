...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
 ...
 <c:set scope="request" var="m" value="1" />
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
			...
			<div class="search">
				<form action="/document/search" class="header_search_form menu_mm">
					<input type="search" class="search_input menu_mm" name ="search" placeholder="Search" required="required">
	...
	<form action="/document/search" id="courses_search_form" class="">
		...
		<p class="pb-2" style="margin-top: -10px;">
			...
			<tbody>  
			 ...
			 <tr>
               <td colspan="4"><p class="text-center">Không có tài liệu nào</p></td>
             </tr>
			</c:if>
